...
set(CPACK_DEBIAN_PACKAGE_MAINTAINER "Exponencial Administração & Tecnologia")
set(CPACK_DEBIAN_PACKAGE_HOMEPAGE "https://github.com/exponencialadm/agent-safe-guard")
